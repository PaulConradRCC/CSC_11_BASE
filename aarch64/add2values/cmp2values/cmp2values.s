...
main:	stp x29, x30, [sp, -16]!	// save frame pointer and link register
	// our code here
	// output our prompt
	...
	ldr x0, adr_x
	ldr x1, adr_y
	ldr x4, [x0]	// x4 holds value of x
	ldr x5, [x1]	// x5 holds value of y

	// let's compare x (x4) and y (x5)
	cmp x4, x5

	// let's add x+y (essentially x4+x5) and store in x3
	adds x3, x4, x5
